...
class PopularJsonAdapter(
  ...
  override fun toString(): String = buildString(29) {
      append("GeneratedJsonAdapter(").append("Popular").append(')') }

  override fun fromJson(reader: JsonReader): Popular {
  ...
  override fun toJson(writer: JsonWriter, value: Popular?) {
    if (value == null) {
