...
@Suppress("DEPRECATION", "unused", "ClassName", "REDUNDANT_PROJECTION", "RedundantExplicitType",
    "LocalVariableName")
class NowPlayingJsonAdapter(
  moshi: Moshi
) : JsonAdapter<NowPlaying>() {
  ...
  override fun toString(): String = buildString(32) {
      append("GeneratedJsonAdapter(").append("NowPlaying").append(')') }

  override fun fromJson(reader: JsonReader): NowPlaying {
  ...
  override fun toJson(writer: JsonWriter, value: NowPlaying?) {
    if (value == null) {
